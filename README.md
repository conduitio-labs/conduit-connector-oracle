...
| `snapshotTable`  | Name of the snapshot table.                                                                                                                                         | false    | `custom_snapshot_table_`                    |
| `trackingTable`  | Name of the tracking table to be used in CDC.                                                                                                                       | false    | `custom_tracking_table_`                    |
| `trigger`        | Name of the trigger to be used in CDC.                                                                                                                              | false    | `custom_trigger_`                           |
